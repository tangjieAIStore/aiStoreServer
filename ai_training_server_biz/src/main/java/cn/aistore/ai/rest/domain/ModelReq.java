...
public class ModelReq extends BaseReq {
    ...
    @Min(value=-2, message = "frequency_penalty的值必须在-2.0 ~ 2.0之间")
    @Max(value=2, message = "frequency_penalty的值必须在-2.0 ~ 2.0之间")
...
//    @NotNull(message = "模型输出格式不能为空")
    ...
    @Min(value = -2, message = "模型存在惩罚系数不能小于-2.0")
    @Max(value = 2, message = "模型存在惩罚系数不能大于2.0")
...
//    @NotNull(message = "模型角色不能为空")
    ...
    @Min(value=-2, message = "temperature的值必须在-2.0 ~ 2.0之间")
    @Max(value=2, message = "temperature的值必须在-2.0 ~ 2.0之间")
     ...
     */
    @Column(name = "top_p")
    @Min(value=0, message = "topP的值必须在0 ~ 1.0之间")
    @Max(value=1, message = "topP的值必须在0 ~ 1.0之间")
    @NotNull(message = "模型多样性及保真度不能为空")
    private Double topP;

    @Column(name = "stream")
    @NotNull(message = "stream不能为空")
    @Min(value=0, message = "stream的值必须为0或1")
    @Max(value=1, message = "stream的值必须为0或1")
